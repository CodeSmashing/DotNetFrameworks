...
namespace Models {
	...
	/// </summary>
	/// <remarks>
	/// <see cref="LocalAppointment"/> breidt <see cref="Appointment"/> uit door een <c>Id</c> eigenschap
	...
	public class LocalAppointment : Appointment {
		...
		/// </summary>
		/// <remarks>
		/// Deze eigenschap overschrijft de basiseigenschap <c>AppointmentType</c> om
		/// lokale (SQLite) synchronisatiescenario's te ondersteunen met behulp van <see cref="LocalAppointmentType"/>.
		/// </remarks>
